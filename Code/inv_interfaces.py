...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_info.setGeometry(QtCore.QRect(10, 100, 651, 16))
        ...
        self.dateEdit_before = QtWidgets.QDateEdit(self.verticalLayoutWidget_6)
        self.dateEdit_before.setObjectName("dateEdit_before")
        self.verticalLayout_6.addWidget(self.dateEdit_before)
        ...
        self.dateEdit_after = QtWidgets.QDateEdit(self.verticalLayoutWidget_7)
        self.dateEdit_after.setObjectName("dateEdit_after")
        self.verticalLayout_7.addWidget(self.dateEdit_after)
        ...
        self.comboBox_unit_view = QtWidgets.QComboBox(self.verticalLayoutWidget_8)
        self.comboBox_unit_view.setObjectName("comboBox_unit_view")
        self.verticalLayout_8.addWidget(self.comboBox_unit_view)
        ...
        self.comboBox_sub_unit_view = QtWidgets.QComboBox(self.verticalLayoutWidget_9)
        self.comboBox_sub_unit_view.setObjectName("comboBox_sub_unit_view")
        self.verticalLayout_9.addWidget(self.comboBox_sub_unit_view)
        ...
        self.textEdit_view_info = QtWidgets.QTextEdit(self.tab_2)
        self.textEdit_view_info.setGeometry(QtCore.QRect(10, 60, 851, 111))
        self.textEdit_view_info.setObjectName("textEdit_view_info")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Внесение остатков по забалансу"))
